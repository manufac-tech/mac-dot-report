    ...
    return {
        ...
        'full_match': {
            ...
            'match_logic': lambda row: (
                (pd.isna(row['item_name_rp_db']) and pd.isna(row['item_name_rp_cf']) and pd.isna(row['item_name_rp'])) or
                ...
                (pd.isna(row['item_name_hm_db']) and pd.isna(row['item_name_hm_cf']) and pd.isna(row['item_name_hm'])) or
